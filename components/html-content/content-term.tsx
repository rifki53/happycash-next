    ...
    <>
      <section className="relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-18 my-18">
          <p className="c13" id="h.uhvmvjt8mm7y">
            <span className="c19">YINSHAN LENDING INC. </span>
          </p>
          <p className="c13">
            <span className="c7">
              Operating under the name of &ldquo;HAPPYCASH&rdquo;
            </span>
          </p>
          <p className="c13">
            <span className="c17">SEC Registration No.: CS201900108</span>
          </p>
          <p className="c13">
            <span className="c17">Certificate of Authority No.: 2860</span>
          </p>
          <p className="c9 c13">
            <span className="c26"></span>
          </p>
          <p className="c13">
            <span className="c6">GENERAL TERMS AND CONDITIONS</span>
          </p>
          <p className="c13 c9">
          ...
          <p className="c0">
            <span className="c3">
              This General terms and Conditions are developed in accordance with
          ...
          <p className="c0">
            <span className="c3">Effective: January 2025. </span>
          </p>
          <p className="c0 c9">
            <span className="c3"></span>
          </p>
          <ol className="c4 lst-kix_list_1-0 start" start={1}>
            <li className="c0 c8 li-bullet-0">
              <span className="c7">Introduction</span>
            </li>
          </ol>
          <p className="c0">
            <span className="c3">
              1.1 Welcome to Yinshan Lending Inc. doing business under the name
              &ldquo;Happycash&rdquo;. Please read these Terms and Conditions
              carefully before using the Services (as defined below), so that
              you are aware of your rights and obligations with respect to the
              Services.
            </span>
          </p>
          <p className="c0">
          ...
          <p className="c0">
            <span className="c3">
              1.2 These Terms and Conditions describe the terms and conditions
              applicable to your use of the Services on the Happycash Platform
              and constitute an agreement that creates a legally binding
              relationship between you and us. You acknowledge and accept that
              these Terms and Conditions also constitute an integral part of the
              Service Documents.
            </span>
          </p>
          <p className="c0">
          ...
          <p className="c0">
            <span className="c3">
              1.3 By using the Services, you agree to be legally bound to these
              Terms and Conditions. You represent and warrant to have read,
              understood and accepted these Terms and Conditions and that you
              will only use the Services for your own benefit (as the beneficial
              owner of your Account with us), or that of the corporation,
              partnership, or sole proprietorship that you duly represent, and
              not for the benefit of any other person or entity. If you do not
              agree to these Terms and Conditions or if you are not the
              beneficial owner or the Authorized Representative (as defined
              below) in using the Services, you must cease your use of the
              Services.
            </span>
          </p>
          <p className="c0">
          ...
          <p className="c0">
            <span className="c3">
              1.4 In using the Services, you acknowledge and agree that you are
              bound by the additional terms and conditions as provided under the
              relevant Loan Agreement (including any other document referred to
              in the Loan Agreement, such as additional terms and conditions)
              which will be deemed incorporated herein by reference and made
              available to you by the relevant Lender prior to, or at the time
              of, their provision of the relevant Credit Facility to you. In the
              event of any conflict or inconsistency between the provisions of
              these Terms and Conditions and the provisions of the Loan
          ...
          <p className="c0">
            <span className="c3">
              1.5 You acknowledge and agree that activation of any Credit
              Facility on the Platform and the reflection of an Available Credit
              Limit does not automatically grant you a Credit Facility and such
              activation and limit only reflect that you can apply for a Credit
              Facility to a certain amount and that we will process such
              application. For the avoidance of doubt, your application for a
              Credit Facility shall still be subject to the approval and grant
              of the Lender and or Facility Manager, as may be applicable.
            </span>
          </p>
          <p className="c0 c9">
            <span className="c3"></span>
          ...
          <ol className="c4 lst-kix_list_1-0" start={2}>
            <li className="c0 c8 li-bullet-0">
          ...
          <p className="c0">
            <span className="c3">
              As used in this Agreement, the following terms and expressions
          ...
          <ol className="c4 lst-kix_list_2-0 start" start={1}>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Borrower - a Loan Applicant whose Loan Application is accepted
                by the Lender.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Borrower&#39;s Obligations - includes payment of the outstanding
                principal amount of the Loan, interest on the Loan, all other
                interest, fees, costs, charges, expenses, processing fee and all
                other sums whatsoever arising from or incident to the loan, and
                payable by the Borrower to the Lender on or before the Maturity
                Date, in accordance with the Terms and Conditions contained
                herein, the Promissory Note, and other related documents
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Calendar Day- any day, including weekends and public holidays in
                the Philippines on which the Lender operates in the ordinary
                course of business.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Cooling-off/Cancellation &ndash; the borrower may cancel the
                loan agreement within three (3) business days from disbursement
                of the loan proceeds by sending a written notice of cancellation
                to the designated email account of the Lender.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Loan Agreement - the agreement entered into by and between the
                Lender and the Borrower providing for the Loan and such other
                related agreements as may be entered into force from time to
                time by the Parties. The Loan Agreement includes the General
                Terms and Conditions stated hereunder, the Promissory Note, the
                Loan Decision, and all schedules and agreements supplemental
                thereto.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Disclosure Statement - the statement given by the Lender to the
                Borrower before the latter accepts the Loan setting forth the
                total amount to be financed, the finance charge, all charges in
                connection with the Loan, and all other items required under the
                Truth in Lending Act.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Distance Service - any communication technique through telematic
                networks facilitated by the Lender so that the Borrower can make
                the Loan Application and receive the Loan Decision. Distance
                Service should be understood as the Website
                https://www.happycash.ph/ or any other similar means or facility
                that the Lender makes available to the Loan Applicant for the
                purpose stated in this Article 1.5.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                General Terms and Conditions - the terms and conditions
                governing the Loan as contained herein, the Loan Agreement
                consisting of the Promissory Note, Disclosure Statement of Loan/
                Credit Transaction, the General Terms and Conditions of loan,
                including all other agreements or documents executed by the
                Lender and/or the Borrower which shall govern the Borrower&#39;s
                loan with the Lender.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c23">
                Lender &ndash; Yinshan Lending Inc. with its principal address
                at 26
              </span>
              <span className="c18">th</span>
              <span className="c3">
                &nbsp;Floor, The World Centre, Gil Puyat Ave., Brgy. Bel-Air,
                Makati City, Metro Manila, Philippines.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Loan - the loan entered into by the Lender and the Borrower, and
                governed by these General Conditions, the Promissory Note and
                the other documents forming an integral part of the Loan
                Agreement, whereby the Lender grants a personal loan to the
                Borrower.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Loan Applicant - a natural person who files the Loan Application
                who shall be of Filipino nationality, over eighteen (18) years
                of age at the time of the filing of the Loan Application, with
                full capacity to contract and enter into the Loan, and with
                permanent address in the Philippines.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Loan Application - declaration of intention made by the Loan
                Applicant through Happycash platform, to request for a Loan in
                accordance with these General Conditions, the Promissory Note,
                and all other documents forming an integral part of the Loan
                Agreement. The Loan Application shall take effect from the date
                it is submitted to the Lender for evaluation and will be subject
                to the internal policies and procedures of the Lender. The
                approved Application will be credited to the Personal Account of
                the Borrower on the Lender&rsquo;s website within _____________
                calendar days from Lender&rsquo;s receipt of Borrower&rsquo;s
                acceptance of the Loan Decision.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Loan Decision - the final irrevocable decision made by the
                Lender granting or denying the Loan Application in accordance
                with these General Conditions, and all other documents forming
                an integral part of the Loan Agreement. It shall contain the
                Loan Amount and the Maturity Date. It shall be issued by the
                Lender to the Borrower no later than one (1) day from the date
                that the Loan Application is received by Lender. The Loan
                Decision will be provided by the Lender immediately upon
                completion of the final step of the loan application.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Loan Term - the period provided under Article 4 of these General
                Conditions.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Maturity Date - the last day of the Loan Term (as provided under
                Section 4) when the Loan Amount and the interest and all other
                fees and charges are due.
              </span>
            </li>
            <li className="c0 c2 li-bullet-2">
              <span className="c3">
                Party - Loan Applicant, the Lender or the Borrower, considered
                individually. Likewise, the &quot;Parties&quot; are collectively
                the Lender, and the Loan Applicant or the Borrower.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Personal Account - means the user account created by the
                Borrower on Lender&rsquo;s web site.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Website - Lender&#39;s website (https://www.happycash.ph/).
              </span>
            </li>
          </ol>
          <p className="c0 c9">
          ...
          <ol className="c4 lst-kix_list_1-0" start={3}>
            <li className="c0 c8 li-bullet-0">
              <span className="c7">LOAN TERMS</span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_3-0 start" start={1}>
            <li className="c0 c2 li-bullet-2">
              <span className="c7">Loan Purpose.</span>
            </li>
          </ol>
          <p className="c0">
            <span className="c3">
              The Loan issued by the Lender is to be used by the Borrower for
              legal and legitimate purpose. The loan proceeds shall be used by
              the Borrower exclusively for personal use.
            </span>
          </p>
          <p className="c0 c9">
            <span className="c3"></span>
          </p>
          <ol className="c4 lst-kix_list_3-0" start={2}>
            <li className="c0 c2 li-bullet-1">
              <span className="c7">Loan Amount.</span>
            </li>
          </ol>
          <p className="c0">
            <span className="c3">
              The Lender agrees to lend to the Borrower, and the Borrower agrees
              to borrow from the Lender, the full amount of the Loan, as
              specified in the Loan Decision and reflected in the Loan Agreement
              and the Borrower&rsquo;s Personal Account.
            </span>
          </p>
          <ol className="c4 lst-kix_list_3-0" start={3}>
            <li className="c0 c2 li-bullet-1">
              <span className="c7">Loan Term.</span>
            </li>
          </ol>
          <p className="c0">
            <span className="c3">
              Loan Term shall refer to the period within which the Borrower
              shall pay the principal amount of the Loan in full, together with
              the corresponding interest and all other charges and fees
              indicated in the Disclosure Statement, which may range from one to
              three months, depending on the term approved under the Loan
              Decision, as indicated in the Promissory Note.
            </span>
          </p>
          <ol className="c4 lst-kix_list_3-0" start={4}>
            <li className="c0 c2 li-bullet-1">
              <span className="c7">Interest</span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_4-0 start" start={1}>
            <li className="c0 c12">
              <span className="c3">
                The Borrower shall be liable to the Lender for interest on the
                Loan until the same is paid in full, which interest shall be
                calculated and paid in accordance with these General Terms and
                Conditions.
              </span>
            </li>
            <li className="c0 c12">
              <span className="c3">
                Interest on the Loan is accrued daily until the Maturity Date.
                The interest rate is determined individually, and indicated in
                the Promissory Note and Disclosure Statement.
              </span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_3-0" start={5}>
            <li className="c0 c2 li-bullet-1">
              <span className="c7">Late Payment Penalties and Fees</span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Any amount received by the Lender from the Borrower after
                Maturity Date will be applied in the order as listed below:
              </span>
            </li>
          </ol>
          <ul className="c4 lst-kix_list_5-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">Any and all charges permitted by law</span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_6-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">Enforcement expenses payment</span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_7-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">Late payment penalties and fees</span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_8-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                All Loan related amounts in the following order: fees, interest
                amount, principal amount
              </span>
            </li>
          </ul>
          <ol className="c4 lst-kix_list_3-0" start={7}>
            <li className="c0 c2 li-bullet-1">
              <span className="c7">
          ...
          <ol className="c4 lst-kix_list_3-1 start" start={1}>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The proceeds of the Loan shall be released only after the
                conditions set out below have been fulfilled to the Lender`s
                approval:
              </span>
            </li>
          </ol>
          <ul className="c4 lst-kix_list_9-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Loan Application is filled in, signed by SMS and sent to the
                Lender
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_10-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
          ...
          <ul className="c4 lst-kix_list_11-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                In the Borrower&#39;s Personal account are uploaded
                Borrower&#39;s Photo with identity document;
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_12-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Loan Decision is reported to, and confirmed and accepted by
                the Borrower through SMS confirmation and/or verbal confirmation
                via direct call.
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_13-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Loan Agreement is confirmed and accepted by the Borrower.
              </span>
            </li>
          </ul>
          <ol className="c4 lst-kix_list_3-1" start={2}>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Once the Loan Application submitted by the Borrower is accepted
                by the Lender, the Borrower shall not be entitled to cancel the
                Loan or to refuse to accept the Loan proceeds, except for cases
                when such a refusal entails the application of charges for
                cancellation, refusal or prepayment as may be stipulated by the
                Lender. The Borrower agrees that the Lender has the right to
                approve/reject the cancellation of the Loan as the Lender deems
                fit.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Lender shall not be responsible for the release of any Loan
                proceeds to other/wrong bank account due to data entry errors by
                the Borrower.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Lender shall also not be liable for any delays or problems
                in the release of any Loan proceeds to the third parties upon
                the written directions and instructions of the Borrower.
              </span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_3-0" start={8}>
            <li className="c0 c2 li-bullet-1">
              <span className="c7">Full/Partial and Early Loan Repayment.</span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_3-1 start" start={1}>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower must pay all Loan amount plus interest accrued on
                the Maturity Date.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower may prepay the whole or any part of the Loan amount
                provided that at least half of the Loan Term has elapsed, and at
                all times not earlier than after __________ calendar days from
                date that the proceeds are remitted to the Borrower.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The amount of the full Loan repayment for the current day will
                be available to the Borrower in the Personal account on the
                Lender&#39;s website.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Information regarding all available methods and channels for
                Loan repayment will be posted and made available to the Borrower
                in the Personal account in Lender&#39;s website.
              </span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_3-0" start={9}>
            <li className="c0 c2 li-bullet-2">
              <span className="c7">Cooling-Off Period and Cancellation</span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_3-1 start" start={1}>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower may cancel the Loan Agreement by sending a written
                notice of cancellation to the Lender within three (3) business
                days from the date of disbursement of the loan proceeds, in
                compliance with the Financial Consumer Protection Act (Republic
                Act No. 11765) and Securities and Exchange Commission (SEC)
                Memorandum Circular No. 3, Series of 2023. &nbsp;
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                All request for cancellation shall be coursed through the
                official customer service email address of the Lender at{" "}
              </span>
              <span className="c11">
                <a className="c21" href="mailto:cs@happycash.ph">
                  cs@happycash.ph
                </a>
              </span>
              <span className="c3">. &nbsp; </span>
            ...
            <li className="c0 c1 li-bullet-2">
              <span className="c3">
                Any notice of cancellation received beyond the three (3)
                calendar day period shall be treated as a prepayment and shall
                be subject to the terms and conditions set forth in Clause 8 of
                this Agreement.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Upon receipt of the notice of cancellation within the prescribed
                period, the Lender will provide the Borrower with payment
                instructions. The Borrower is responsible for returning the
                principal loan amount along with a processing fee of two hundred
                twenty pesos (Php 220.00). This ensures a clear understanding of
                the financial obligations associated with the cancellation.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                However, if the loan amount is minimal, the processing fee will
                be equivalent to the original interest accrued on the loan. This
                adjustment aims to prevent disproportionately high fees on
                smaller loan values, making the process equitable for borrowers.
                For example, if a borrower has a loan amount of Php 500.00, the
                processing fee will be the original interest rather than the
                standard Php 220.00. Consequently, the total amount payable by
                the borrower would be Php 575.00, which includes the principal
                amount and the adjusted processing fee. &nbsp;
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Furthermore, the Borrower&rsquo;s right to cancel this Agreement
                within the prescribed three (3) days cooling-off period shall be
                without penalty or other charges, except for any reasonable and
                commensurate processing fee disclosed prior to contract
                acceptance and stipulated in Clause 9 (d) and (e). Cancellation
                within this period shall immediately cease any further interest
                accrual or charges related to the loan.
              </span>
            </li>
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                No fees, other than the disclosed processing fee, shall be
                charged for exercising this right, ensuring compliance with
                applicable laws and regulations, including SEC Memorandum
                Circular No. 3, Series of 2023 and Republic Act No. 11765.
              </span>
            </li>
          </ol>
          <p className="c0 c9">
          ...
          <ol className="c4 lst-kix_list_1-0" start={4}>
            <li className="c0 c8 li-bullet-0">
              <span className="c7">REPRESENTATIONS AND UNDERTAKINGS</span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_14-0 start" start={1}>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
          ...
          <ul className="c4 lst-kix_list_26-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower shall apply the loan proceeds to his/her personal
                use only such as education, hospitalization, emergency, travel,
                household, and other personal consumption needs of a similar
                nature.
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_27-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower shall comply in all respect with all applicable
                laws in connection with the performance of the Borrower&rsquo;s
                obligations under the Loan Agreement and this Terms &amp;
                Conditions, and other relevant documents;
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_28-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower shall obtain and maintain in full force and effect
                any authorization, consent or approval required to enable the
                Borrower to perform the Borrower&rsquo;s obligations under this
                Loan Agreement and this Terms &amp; Conditions, and other
                relevant documents and to ensure the legality, validity,
                enforceability or admissibility in evidence of this Loan
                Agreement, Terms &amp; Conditions, and other relevant documents.
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_29-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower shall notify the Lender in writing of any potential
                or actual Event of Default (if any is specified in the Loan
                Agreement) and any event or circumstance which constitutes a
                default under any other agreement binding upon the Borrower
                (and, in each case, the steps, if any, being taken to remedy it)
                promptly upon becoming aware of its occurrence;
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_30-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower shall provide a prior written notice to the Lender
                of any change in the Borrower&rsquo;s name, date of birth,
                residential address within three (3) calendar days of such
                changes;
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_31-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                The Borrower shall notify the Lender of any change in the
                Borrower&rsquo;s employment, business or profession. In the
                event the Borrower is self-employed, the Borrower hereby
                undertakes to keep the Lender informed about the personal
                financial conditions on a periodic basis as requested by the
                Lender.
              </span>
            </li>
          </ul>
          <p className="c0 c9 c25">
            <span className="c3"></span>
          </p>
          <ol className="c4 lst-kix_list_1-0" start={5}>
            <li className="c0 c8 li-bullet-0">
              <span className="c7">DEFAULT</span>
            </li>
          </ol>
          ...
          <p className="c0 c5">
            <span className="c3">Should an Event of Default occur:</span>
          </p>
          <ul className="c4 lst-kix_list_40-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Lender shall have the right, at its discretion, to consider the
                full amount of the Loan as immediately due and demandable, and
                require Borrower to make full and immediate payment thereof;
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_41-1 start">
            <li className="c0 c1 li-bullet-2">
              <span className="c3">
                If the default is a result of a failure of the Borrower to
                timely pay the Loan, the Late Payment Penalties and Fees
                prescribed under Article 7 shall apply;
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_42-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Lender shall have all the rights to the remedies provided in the
                Loan Agreement and in law for purposes of enforcing its claims
          ...
          <p className="c0">
            <span className="c3">
              To the extent allowed under Philippine law, Borrower accepts to
              waive any notice or formality meant to enable the Lender to
              exercise its rights arising from the occurrence of an Event of
              Default. The failure or the delay to exercise any right, options,
              power or privilege hereunder shall not operate as a waiver of any
              right of the Lender to exercise the same hereunder, unless said
              waiver is given in writing by the Lender, and then only to the
              extent specifically set forth in said writing.
            </span>
          </p>
          <p className="c0">
          ...
          <ol className="c4 lst-kix_list_43-0 start" start={1}>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                The Borrower shall indemnify the Lender against any cost, loss
                or liability incurred by the Lender as a result of:
              </span>
            </li>
          </ol>
          <ul className="c4 lst-kix_list_44-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
          ...
          <ul className="c4 lst-kix_list_45-1 start">
            <li className="c0 c1 li-bullet-2">
              <span className="c3">
                The information produced or confirmed by the Borrower being or
                being alleged to be misleading and/or deceptive in any respect;
              </span>
            </li>
          </ul>
          <ul className="c4 lst-kix_list_46-1 start">
            <li className="c0 c1 li-bullet-1">
              <span className="c3">
                Any inquiry, investigation, subpoena (or similar order or
                litigation with respect to the Borrower) or with respect to the
                transactions contemplated or financed under this Loan Agreement
          ...
          <ol className="c4 lst-kix_list_1-0" start={6}>
            <li className="c0 c8 li-bullet-0">
              <span className="c7">DISCLOSURE OF INFORMATION</span>
            </li>
          </ol>
          <ol className="c4 lst-kix_list_47-0 start" start={1}>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                The Borrower hereby expressly permits the Lender to transfer and
                disclose to (i) the government authorities; (ii) any
                party/person proposing or considering to tender any payment
                towards or purchase the indebtedness under the Loan; (iii) its
                auditors, lawyers or any other debt collection agents; (v)
                credit reporting agencies; (vi) insurance companies, agents,
                contractors or third party service providers who are involved in
                the provision of products and services to or by the Lender and
                the holding company, head office, other branches, subsidiaries,
                related companies of the Lender; or (vii) for provision of or
                cross selling of products and services, any information relating
                to the Borrower&rsquo;s affairs or account in respect of the
                Loan, this Loan Agreement and the Promissory Note, and at any
                time and to such extent as the Lender may at its absolute
                discretion deem expedient or necessary. The Borrower hereby
                agrees that the aforesaid information may be used, encrypted,
                transmitted and stored by the Lender and its holding company,
                head office, other branches, subsidiaries, related companies
                and/or may be exchanged to or with all such persons as the
                Lender considers necessary to the extent as permitted by
                Philippine laws. The aforesaid actions are without liability to
                the Borrower. The Borrower expressly consents to such actions
                and declares that no further consent from the Borrower is
                necessary or required in relation thereto.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                Notification Regarding R.A. No. 9510. Pursuant to Republic Act
                (R.A.) No. 9510 and its Implementing Rules and Regulations
                (IRR), creating the Credit Information Corporation (CIC) we are
                mandated to submit your basic credit data (as defined in R.A.
                No. 9510 and its IRR), as well as any regular updates or
                corrections thereof, to the CIC for consolidation and disclosure
                as may be authorized by the CIC, and other credit reporting
                agencies duly accredited by CIC, for the purpose of establishing
                your creditworthiness.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                In case the Borrower fails to pay fully or correctly or timely
                the loan obligation, in addition to debt recovery measures as
                specified herein/therein or in accordance with the Philippine
                laws, the Lender shall be entitled to provide information on
                such failure to third parties, including but not limited to
                collection agencies for the purpose of collecting the loan
                obligation.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                The Borrower agrees that Lender, directly or through its
                Partners, may collect, retrieve, process, use and store his/her
                personal data such as name, age, photographs, fingerprints,
                other biometric data (e.g., facial recognition and voice
                recognition), mobile number/s, mobile phone usage data,
                employment details, income, financial data, financial profile,
                credit standing, loan payment history, and other information
                required in the application form for the purpose of reviewing
                and processing the Borrower&rsquo;s loan application. The
                Borrower consents to the collection of his/her personal data
                from the Borrower her/himself, or from other personal
                information controllers such as, but not limited to,
                telecommunications companies (e.g., Globe, PLDT, Smart, Sun
                Cellular), for credit scoring purposes. The Borrower&rsquo;s
                personal data such as mobile number, email address, and address,
                will be shared to a credit scoring service provider for credit
                investigation, credit scoring, data analytics, and data
                profiling, which includes the regular updating of the
                Borrower&rsquo;s credit score. The personal data secured may
                also be used for direct marketing of products and services of
                Partners of the Lender. Throughout the processing of the
                Borrower&rsquo;s personal data, his/her rights under the Data
                Privacy Act of 2012, such as the (1) right to be informed, (2)
                right to object, (3) right to access, (4) right to
                rectification, (5) right to erasure or blocking, and (6) right
                to damages, shall be upheld. Entities to whom Lender share
                Borrower&rsquo;s personal data will also respect the same
                rights.
              </span>
            </li>
          </ol>
          ...
          <p className="c0">
            <span className="c3">Review</span>
          </p>
          <ol className="c4 lst-kix_list_48-0 start" start={1}>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                The Loan is subject to the Lender&#39;s review at any time and
                also subject to the Lender&#39;s overriding right of withdrawal
                and repayment on demand, which the Lender reserves the right to
                exercise at any time.
              </span>
            </li>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                The Lender shall have the right to review and revise the Terms
                and Conditions specified hereunder at any time at its sole
                discretion.
              </span>
            </li>
          </ol>
          <p className="c0 c9 c16">
            <span className="c3"></span>
          </p>
          <p className="c0">
            <span className="c3">Notices</span>
          </p>
          <ol className="c4 lst-kix_list_49-0 start" start={1}>
            <li className="c0 c2 li-bullet-1">
          ...
          <ol className="c4 lst-kix_list_54-0 start" start={1}>
            <li className="c0 c2 li-bullet-1">
              <span className="c3">
                ...
                <br />
                Notices, demands or other communications shall be addressed to
                the Lender at its place of residence and may be delivered
                personally, by leaving it at such address, by facsimile
                transmission or telex, or email, or by phone and shall be deemed
                to have been delivered to the Lender on the day of actual
                receipt.
              </span>
            </li>
          </ol>
          ...
          <p className="c0">
            <span className="c3">
              ...
              arrangements of whatever nature whatsoever, both written and oral,
          ...
          <p className="c0">
            <span className="c3">Assignment and Transfer</span>
          </p>
          <p className="c0">
            <span className="c3">
              Notwithstanding any other provisions of this Loan Agreement and/or
              the Promissory Note, the Lender may at any time: (i) assign or
              transfer its rights and obligations; or (ii) create security in or
              over any and all of its rights or obligations under this Loan
              Agreement and the Promissory Note to any person on provision of
              seven (7) Business Day written notice to the Borrower. The
              Borrower is not permitted to assign or transfer any of the
              Borrower&rsquo;s rights or obligations under this Loan Agreement
              and the Promissory Note without prior written consent of the
              Lender.
            </span>
          </p>
          <p className="c0 c9">
          ...
          <p className="c0">
            <span className="c3">
              The delay or failure of the Lender to exercise of any of its
              rights whether under this Loan Agreement, the Promissory Note, or
              otherwise, shall not be construed or deemed as a waiver of the
              Lender to such rights.
            </span>
          </p>
          <p className="c0 c9">
            <span className="c3"></span>
          ...
          <p className="c0">
            <span className="c3">Language and Governing Law</span>
          </p>
          <p className="c0">
            <span className="c3">
              This Loan Agreement and the Promissory Note are governed by the
              laws of the Philippines. The competent courts of Philippines have
              jurisdiction to settle any dispute arising out of or in connection
              with this Loan Agreement and the Promissory Note (including all
          ...
          <p className="c0">
            <span className="c3">Term of the Loan Agreement</span>
          </p>
          <p className="c0">
            <span className="c3">
              Unless terminated by the Lender, this Loan Agreement shall take
              effect from the date the funds are remitted to the Borrower in the
              manner specified in Promissory Note until such time as the
              provisions specified hereunder are needed to remain in force and
              effect between the Parties unless otherwise agreed by the Parties.
            </span>
          </p>
          <p className="c13 c9">
            <span className="c6"></span>
          ...
          <p className="c22">
            <span className="c14">(Date), Makati City. </span>
          </p>
          <p className="c22">
            <span className="c14">
              This is an electronic document. Hence, no signature is required.
            </span>
          </p>
          <p className="c10 c9">
            <span className="c6"></span>
        ...
        <style jsx>
          {`
            ...
            ol.lst-kix_list_52-4.start {
              counter-reset: lst-ctn-kix_list_52-4 0;
            }
            .lst-kix_list_1-3 > li {
            ...
            ol.lst-kix_list_49-4.start {
              counter-reset: lst-ctn-kix_list_49-4 0;
            }
            .lst-kix_list_8-0 > li {
            ...
            .lst-kix_list_48-2 > li {
              counter-increment: lst-ctn-kix_list_48-2;
            }
            ol.lst-kix_list_48-1.start {
            ...
            .lst-kix_list_53-2 > li {
              counter-increment: lst-ctn-kix_list_53-2;
            }
            ol.lst-kix_list_10-8.start {
              counter-reset: lst-ctn-kix_list_10-8 0;
            }
            .lst-kix_list_48-0 > li {
            ...
            .lst-kix_list_53-4 > li {
              counter-increment: lst-ctn-kix_list_53-4;
            }
            ...
            .lst-kix_list_52-0 > li {
              counter-increment: lst-ctn-kix_list_52-0;
            }
            ...
            .lst-kix_list_49-4 > li {
              counter-increment: lst-ctn-kix_list_49-4;
            }
            ...
            .lst-kix_list_52-7 > li {
              counter-increment: lst-ctn-kix_list_52-7;
            }
            ...
            .lst-kix_list_49-8 > li {
              counter-increment: lst-ctn-kix_list_49-8;
            }
            ...
            .lst-kix_list_52-3 > li {
              counter-increment: lst-ctn-kix_list_52-3;
            }
            ...
            ol.lst-kix_list_52-6.start {
              counter-reset: lst-ctn-kix_list_52-6 0;
            }
            ...
            .lst-kix_list_54-7 > li:before {
              content: "" counter(lst-ctn-kix_list_54-7, decimal) ". ";
            }
            .lst-kix_list_19-8 > li {
              counter-increment: lst-ctn-kix_list_19-8;
            }
            ol.lst-kix_list_48-3.start {
            ...
            .lst-kix_list_49-3 > li:before {
              content: "" counter(lst-ctn-kix_list_49-3, decimal) ". ";
            }
            .lst-kix_list_1-0 > li {
            ...
            .lst-kix_list_48-7 > li:before {
              content: "" counter(lst-ctn-kix_list_48-7, decimal) ". ";
            }
            ...
            .lst-kix_list_51-4 > li:before {
              content: "" counter(lst-ctn-kix_list_51-4, decimal) ". ";
            }
            ...
            .lst-kix_list_49-2 > li {
              counter-increment: lst-ctn-kix_list_49-2;
            }
            .lst-kix_list_34-6 > li {
              counter-increment: lst-ctn-kix_list_34-6;
            }
            .lst-kix_list_51-8 > li:before {
              content: "" counter(lst-ctn-kix_list_51-8, decimal) ". ";
            }
            .lst-kix_list_51-7 > li:before {
              content: "" counter(lst-ctn-kix_list_51-7, decimal) ". ";
            }
            ol.lst-kix_list_52-2.start {
              counter-reset: lst-ctn-kix_list_52-2 0;
            }
            ...
            ol.lst-kix_list_52-7.start {
              counter-reset: lst-ctn-kix_list_52-7 0;
            }
            .lst-kix_list_50-1 > li:before {
              content: "• ";
            }
            .lst-kix_list_50-2 > li:before {
              content: "" counter(lst-ctn-kix_list_50-2, decimal) ". ";
            }
            ...
            .lst-kix_list_50-8 > li:before {
              content: "" counter(lst-ctn-kix_list_50-8, decimal) ". ";
            }
            .lst-kix_list_50-5 > li:before {
              content: "" counter(lst-ctn-kix_list_50-5, decimal) ". ";
            }
            ...
            .lst-kix_list_52-7 > li:before {
              content: "" counter(lst-ctn-kix_list_52-7, decimal) ". ";
            }
            ...
            ol.lst-kix_list_49-6.start {
              counter-reset: lst-ctn-kix_list_49-6 0;
            }
            ol.lst-kix_list_28-6 {
              list-style-type: none;
            }
            .lst-kix_list_52-3 > li:before {
              content: "" counter(lst-ctn-kix_list_52-3, decimal) ". ";
            }
            ...
            .lst-kix_list_53-5 > li:before {
              content: "" counter(lst-ctn-kix_list_53-5, decimal) ". ";
            }
            ...
            ol.lst-kix_list_53-8.start {
              counter-reset: lst-ctn-kix_list_53-8 0;
            }
            ol.lst-kix_list_8-8 {
              list-style-type: none;
            }
            ...
            ol.lst-kix_list_54-0.start {
              counter-reset: lst-ctn-kix_list_54-0 0;
            }
            ...
            .lst-kix_list_52-2 > li {
              counter-increment: lst-ctn-kix_list_52-2;
            }
            ol.lst-kix_list_8-2 {
              list-style-type: none;
            }
            ...
            .lst-kix_list_53-6 > li {
              counter-increment: lst-ctn-kix_list_53-6;
            }
            ...
            .lst-kix_list_53-2 > li:before {
              content: "" counter(lst-ctn-kix_list_53-2, decimal) ". ";
            }
            .lst-kix_list_53-3 > li:before {
              content: "" counter(lst-ctn-kix_list_53-3, decimal) ". ";
            }
            ...
            ol.lst-kix_list_49-5.start {
              counter-reset: lst-ctn-kix_list_49-5 0;
            }
            ...
            ol.lst-kix_list_49-0.start {
              counter-reset: lst-ctn-kix_list_49-0 0;
            }
            ...
            .lst-kix_list_48-5 > li:before {
              content: "" counter(lst-ctn-kix_list_48-5, decimal) ". ";
            }
            .lst-kix_list_9-7 > li {
            ...
            .lst-kix_list_48-1 > li:before {
              content: "" counter(lst-ctn-kix_list_48-1, decimal) ". ";
            }
            .lst-kix_list_52-6 > li:before {
              content: "" counter(lst-ctn-kix_list_52-6, decimal) ". ";
            }
            ...
            .lst-kix_list_53-6 > li:before {
              content: "" counter(lst-ctn-kix_list_53-6, decimal) ". ";
            }
            ...
            .lst-kix_list_54-2 > li:before {
              content: "" counter(lst-ctn-kix_list_54-2, decimal) ". ";
            }
            ol.lst-kix_list_49-2.start {
              counter-reset: lst-ctn-kix_list_49-2 0;
            }
            ol.lst-kix_list_4-4 {
              list-style-type: none;
            }
            ...
            ol.lst-kix_list_53-0.start {
              counter-reset: lst-ctn-kix_list_53-0 0;
            }
            .lst-kix_list_7-0 > li {
            ...
            ol.lst-kix_list_49-7.start {
              counter-reset: lst-ctn-kix_list_49-7 0;
            }
            ...
            ol.lst-kix_list_54-7 {
              list-style-type: none;
            }
            ol.lst-kix_list_54-8 {
              list-style-type: none;
            }
            ol.lst-kix_list_54-5 {
              list-style-type: none;
            }
            ol.lst-kix_list_54-6 {
              list-style-type: none;
            }
            ol.lst-kix_list_54-3 {
              list-style-type: none;
            }
            ...
            ol.lst-kix_list_53-5.start {
              counter-reset: lst-ctn-kix_list_53-5 0;
            }
            ...
            ol.lst-kix_list_53-7.start {
              counter-reset: lst-ctn-kix_list_53-7 0;
            }
            ...
            .lst-kix_list_52-8 > li {
              counter-increment: lst-ctn-kix_list_52-8;
            }
            ...
            .lst-kix_list_49-4 > li:before {
              content: "" counter(lst-ctn-kix_list_49-4, decimal) ". ";
            }
            ol.lst-kix_list_10-5.start {
              counter-reset: lst-ctn-kix_list_10-5 0;
            }
            .lst-kix_list_54-5 > li:before {
              content: "" counter(lst-ctn-kix_list_54-5, decimal) ". ";
            }
            ...
            .lst-kix_list_48-8 > li:before {
              content: "" counter(lst-ctn-kix_list_48-8, decimal) ". ";
            }
            ol.lst-kix_list_40-4.start {
              counter-reset: lst-ctn-kix_list_40-4 0;
            }
            .lst-kix_list_53-0 > li {
              counter-increment: lst-ctn-kix_list_53-0;
            }
            ...
            ol.lst-kix_list_53-3.start {
              counter-reset: lst-ctn-kix_list_53-3 0;
            }
            ...
            .lst-kix_list_52-0 > li:before {
              content: "" counter(lst-ctn-kix_list_52-0, decimal) ". ";
            }
            ...
            .lst-kix_list_52-5 > li {
              counter-increment: lst-ctn-kix_list_52-5;
            }
            ...
            ol.lst-kix_list_53-4.start {
              counter-reset: lst-ctn-kix_list_53-4 0;
            }
            .lst-kix_list_4-6 > li {
            ...
            ol.lst-kix_list_53-2.start {
              counter-reset: lst-ctn-kix_list_53-2 0;
            }
            .lst-kix_list_53-3 > li {
              counter-increment: lst-ctn-kix_list_53-3;
            }
            .lst-kix_list_49-7 > li:before {
              content: "" counter(lst-ctn-kix_list_49-7, decimal) ". ";
            }
            ...
            .lst-kix_list_54-8 > li:before {
              content: "" counter(lst-ctn-kix_list_54-8, decimal) ". ";
            }
            ...
            ol.lst-kix_list_53-6.start {
              counter-reset: lst-ctn-kix_list_53-6 0;
            }
            ol.lst-kix_list_48-2.start {
            ...
            ol.lst-kix_list_49-8.start {
              counter-reset: lst-ctn-kix_list_49-8 0;
            }
            .lst-kix_list_4-2 > li {
            ...
            ol.lst-kix_list_52-5.start {
              counter-reset: lst-ctn-kix_list_52-5 0;
            }
            ...
            .lst-kix_list_49-7 > li {
              counter-increment: lst-ctn-kix_list_49-7;
            }
            ...
            .lst-kix_list_52-6 > li {
              counter-increment: lst-ctn-kix_list_52-6;
            }
            ...
            ol.lst-kix_list_49-3.start {
              counter-reset: lst-ctn-kix_list_49-3 0;
            }
            ...
            .lst-kix_list_49-5 > li {
              counter-increment: lst-ctn-kix_list_49-5;
            }
            ...
            ol.lst-kix_list_52-8.start {
              counter-reset: lst-ctn-kix_list_52-8 0;
            }
            .lst-kix_list_19-4 > li:before {
              content: "" counter(lst-ctn-kix_list_19-4, decimal) ". ";
            }
            ol.lst-kix_list_53-8 {
              list-style-type: none;
            }
            ...
            ol.lst-kix_list_53-6 {
              list-style-type: none;
            }
            ol.lst-kix_list_53-7 {
              list-style-type: none;
            }
            ol.lst-kix_list_53-4 {
              list-style-type: none;
            }
            ol.lst-kix_list_53-5 {
              list-style-type: none;
            }
            ol.lst-kix_list_53-2 {
              list-style-type: none;
            }
            ol.lst-kix_list_53-3 {
              list-style-type: none;
            }
            ol.lst-kix_list_53-0 {
              list-style-type: none;
            }
            ...
            .lst-kix_list_49-0 > li {
              counter-increment: lst-ctn-kix_list_49-0;
            }
            ...
            .lst-kix_list_53-8 > li {
              counter-increment: lst-ctn-kix_list_53-8;
            }
            ...
            .lst-kix_list_48-2 > li:before {
              content: "" counter(lst-ctn-kix_list_48-2, decimal) ". ";
            }
            .lst-kix_list_27-3 > li:before {
              content: "" counter(lst-ctn-kix_list_27-3, decimal) ". ";
            }
            .lst-kix_list_48-4 > li:before {
              content: "" counter(lst-ctn-kix_list_48-4, decimal) ". ";
            }
            ol.lst-kix_list_48-5.start {
            ...
            .lst-kix_list_53-5 > li {
              counter-increment: lst-ctn-kix_list_53-5;
            }
            ...
            ol.lst-kix_list_52-3.start {
              counter-reset: lst-ctn-kix_list_52-3 0;
            }
            ...
            .lst-kix_list_49-8 > li:before {
              content: "" counter(lst-ctn-kix_list_49-8, decimal) ". ";
            }
            ...
            .lst-kix_list_49-6 > li:before {
              content: "" counter(lst-ctn-kix_list_49-6, decimal) ". ";
            }
            ...
            .lst-kix_list_49-0 > li:before {
              content: "" counter(lst-ctn-kix_list_49-0, decimal) ". ";
            }
            ...
            ol.lst-kix_list_52-0.start {
              counter-reset: lst-ctn-kix_list_52-0 0;
            }
            ...
            .lst-kix_list_53-0 > li:before {
              content: "" counter(lst-ctn-kix_list_53-0, decimal) ". ";
            }
            ...
            .lst-kix_list_52-4 > li:before {
              content: "" counter(lst-ctn-kix_list_52-4, decimal) ". ";
            }
            ...
            .lst-kix_list_51-5 > li:before {
              content: "" counter(lst-ctn-kix_list_51-5, decimal) ". ";
            }
            ...
            .lst-kix_list_51-2 > li:before {
              content: "" counter(lst-ctn-kix_list_51-2, decimal) ". ";
            }
            .lst-kix_list_51-3 > li:before {
              content: "" counter(lst-ctn-kix_list_51-3, decimal) ". ";
            }
            ...
            .lst-kix_list_51-6 > li:before {
              content: "" counter(lst-ctn-kix_list_51-6, decimal) ". ";
            }
            ...
            .lst-kix_list_50-3 > li:before {
              content: "" counter(lst-ctn-kix_list_50-3, decimal) ". ";
            }
            .lst-kix_list_50-4 > li:before {
              content: "" counter(lst-ctn-kix_list_50-4, decimal) ". ";
            }
            ...
            .lst-kix_list_50-7 > li:before {
              content: "" counter(lst-ctn-kix_list_50-7, decimal) ". ";
            }
            ...
            .lst-kix_list_50-6 > li:before {
              content: "" counter(lst-ctn-kix_list_50-6, decimal) ". ";
            }
            ...
            .lst-kix_list_52-5 > li:before {
              content: "" counter(lst-ctn-kix_list_52-5, decimal) ". ";
            }
            ...
            .lst-kix_list_53-7 > li {
              counter-increment: lst-ctn-kix_list_53-7;
            }
            ...
            .lst-kix_list_53-7 > li:before {
              content: "" counter(lst-ctn-kix_list_53-7, decimal) ". ";
            }
            ...
            .lst-kix_list_49-3 > li {
              counter-increment: lst-ctn-kix_list_49-3;
            }
            ...
            .lst-kix_list_52-2 > li:before {
              content: "" counter(lst-ctn-kix_list_52-2, decimal) ". ";
            }
            ...
            .lst-kix_list_49-5 > li:before {
              content: "" counter(lst-ctn-kix_list_49-5, decimal) ". ";
            }
            .lst-kix_list_13-0 > li:before {
              content: "" counter(lst-ctn-kix_list_13-0, decimal) ". ";
            }
            ol.lst-kix_list_48-8 {
              list-style-type: none;
            }
            ul.lst-kix_list_37-1 {
              list-style-type: none;
            }
            ol.lst-kix_list_48-6 {
              list-style-type: none;
            }
            ol.lst-kix_list_48-7 {
              list-style-type: none;
            }
            ol.lst-kix_list_48-4 {
              list-style-type: none;
            }
            ol.lst-kix_list_48-5 {
              list-style-type: none;
            }
            ol.lst-kix_list_48-2 {
              list-style-type: none;
            }
            .lst-kix_list_13-4 > li:before {
              content: "" counter(lst-ctn-kix_list_13-4, decimal) ". ";
            }
            ol.lst-kix_list_48-3 {
              list-style-type: none;
            }
            ol.lst-kix_list_48-0 {
              list-style-type: none;
            }
            ol.lst-kix_list_48-1 {
              list-style-type: none;
            }
            ...
            .lst-kix_list_54-6 > li:before {
              content: "" counter(lst-ctn-kix_list_54-6, decimal) ". ";
            }
            ...
            .lst-kix_list_54-3 > li:before {
              content: "" counter(lst-ctn-kix_list_54-3, decimal) ". ";
            }
            ...
            .lst-kix_list_49-2 > li:before {
              content: "" counter(lst-ctn-kix_list_49-2, decimal) ". ";
            }
            ...
            .lst-kix_list_52-8 > li:before {
              content: "" counter(lst-ctn-kix_list_52-8, decimal) ". ";
            }
            ol.lst-kix_list_17-8.start {
              counter-reset: lst-ctn-kix_list_17-8 0;
            }
            .lst-kix_list_49-6 > li {
              counter-increment: lst-ctn-kix_list_49-6;
            }
            .lst-kix_list_1-5 > li {
            ...
            ol.lst-kix_list_52-7 {
              list-style-type: none;
            }
            .lst-kix_list_53-4 > li:before {
              content: "" counter(lst-ctn-kix_list_53-4, decimal) ". ";
            }
            ol.lst-kix_list_52-8 {
              list-style-type: none;
            }
            ol.lst-kix_list_52-5 {
              list-style-type: none;
            }
            ol.lst-kix_list_52-6 {
              list-style-type: none;
            }
            ol.lst-kix_list_42-8.start {
              counter-reset: lst-ctn-kix_list_42-8 0;
            }
            ol.lst-kix_list_52-3 {
              list-style-type: none;
            }
            ol.lst-kix_list_52-4 {
              list-style-type: none;
            }
            ol.lst-kix_list_52-2 {
              list-style-type: none;
            }
            ol.lst-kix_list_52-0 {
              list-style-type: none;
            }
